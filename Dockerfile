...
# Dot files
ADD .jshintrc .bowerrc .editorconfig .travis.yml bower.json Gruntfile.js LICENSE package.json README.md $SOURCE_DIR/

# Add some git files for versioning
ADD .git/HEAD .git/refs $SOURCE_DIR/.git/
...
#RUN apt-get -y --auto-remove purge git nodejs nodejs-legacy npm bzip2 && \
